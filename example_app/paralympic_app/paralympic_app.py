...
def init_layout(app):
    """
    Create a charts and layout for the Dashboard.
    """
    ...
    # Initialise callbacks after the app has loaded
    # Pass app as a parameter
    init_callbacks(app)
...
def init_callbacks(app):
    """ Create the callbacks for a Plotly Dash app. """
